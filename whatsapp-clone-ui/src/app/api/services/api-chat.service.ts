...
import { ModelChatResponseModel } from '../models/model-chat-response-model';
...
export class ApiChatService extends BaseService {
   ...
   */
  getChatsByReceiver$Response(params?: GetChatsByReceiver$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<ModelChatResponseModel>>> {
   ...
   * This method doesn't expect any request body.
   */
  getChatsByReceiver(params?: GetChatsByReceiver$Params, context?: HttpContext): Observable<Array<ModelChatResponseModel>> {
    return this.getChatsByReceiver$Response(params, context).pipe(
      map((r: StrictHttpResponse<Array<ModelChatResponseModel>>): Array<ModelChatResponseModel> => r.body)
    );
  }
