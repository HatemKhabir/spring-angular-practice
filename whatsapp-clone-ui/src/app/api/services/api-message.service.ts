...
import { ModelMessageResponseModel } from '../models/model-message-response-model';
...
export class ApiMessageService extends BaseService {
   ...
   * This method doesn't expect any request body.
   */
  getMessages$Response(params: GetMessages$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<ModelMessageResponseModel>>> {
   ...
   * This method doesn't expect any request body.
   */
  getMessages(params: GetMessages$Params, context?: HttpContext): Observable<Array<ModelMessageResponseModel>> {
    return this.getMessages$Response(params, context).pipe(
      map((r: StrictHttpResponse<Array<ModelMessageResponseModel>>): Array<ModelMessageResponseModel> => r.body)
    );
  }
